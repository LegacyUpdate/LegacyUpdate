...
STDMETHODIMP CLegacyUpdateCtrl::UpdateRegistry(BOOL bRegister) {
	if (bRegister) {
		RegistryEntry entries[] = {
			...
			{HKEY_CLASSES_ROOT, L"CLSID\\%CLSID_LegacyUpdateCtrl%\\Programmable", NULL, REG_SZ, (LPVOID)L""},
			...
			{HKEY_CLASSES_ROOT, L"CLSID\\%CLSID_LegacyUpdateCtrl%\\Control", NULL, REG_SZ, (LPVOID)L""},
			...
			{HKEY_CLASSES_ROOT, L"CLSID\\%CLSID_LegacyUpdateCtrl%\\Implemented Categories\\{7DD95801-9882-11CF-9FA9-00AA006C42C4}", NULL, REG_SZ, (LPVOID)L""},
			{HKEY_CLASSES_ROOT, L"CLSID\\%CLSID_LegacyUpdateCtrl%\\Implemented Categories\\{7DD95802-9882-11CF-9FA9-00AA006C42C4}", NULL, REG_SZ, (LPVOID)L""},
			{}
		};
